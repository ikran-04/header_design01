...
const Hero = () => {
  return (
    <div className='w-full h-4/5  flex justify-between items-center '>
            <div className='w-1/3 p-5 z-10 space-y-5'>
                <p className='text-green-500 font-bold'>Plants Shop</p>
                <h1 className='text-7xl leading-snug'>Home Is <span className='font-bold'>Where My <span className='rounded-md px-2 bg-green-500 text-white'>Plants</span> Are</span></h1>
    ...
    <img src="img.jpg" alt="" className="absolute top-0 w-1/4 h-screen object-cover"/>

    </div>
            <div className='w-1/4 h-full p-5 flex flex-col justify-around z-10 space-y-5 '>
