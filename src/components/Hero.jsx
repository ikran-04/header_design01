  ...
  return (
    <div className='w-full h-4/5  flex flex-col md:flex-row justify-between items-center'>
            <div className='md:w-1/3 p-5 z-10 space-y-5'>
                ...
                <h1 className='text-7xl leading-[6rem] '>Home Is <span className='font-bold'>Where My <span className='rounded-md px-2 bg-green-500 text-white'>Plants</span> Are</span></h1>
                ...
                <div className='flex items-center space-x-5'>
                    ...
                    <button className='flex items-center space-x-2'><img src="/play.png" alt="" className='w-8 h-8'/> <span>Watch Our Videos</span></button>
                </div>
            </div>
    ...
    <img src="img.jpg" alt="" className="absolute top-0 w-1/2 md:w-1/4 h-screen object-cover"/>
            ...
            <div className='md:w-1/4 h-full p-5 flex flex-col justify-around z-10 space-y-5 '>
                ...
                <div className='space-y-4'>
                    <h1 className='text-3xl font-bold'>MONTERA</h1>
